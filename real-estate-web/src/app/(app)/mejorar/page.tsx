            ...
            <Card className="md:col-span-3">
              <CardContent className="space-y-5 p-6">
                ...
                <div className="flex items-center gap-3 rounded-xl border border-outline-variant/50 bg-surface-container-low p-3">
                  <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#0056D2] text-sm font-bold text-white">
                    TBK
                  </span>
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-semibold text-on-surface">Transbank</p>
                    <p className="text-xs text-on-surface-variant">
                      Webpay · pago seguro con tarjetas de débito y crédito
                    </p>
                  </div>
                ...
                <p className="flex items-center justify-center gap-1 text-xs text-on-surface-variant">
                  ...
                  Pago seguro vía Webpay (Transbank) · demo sin cargo real
                </p>
              </CardContent>
            </Card>
          </div>
